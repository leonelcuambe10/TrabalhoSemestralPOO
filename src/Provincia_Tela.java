 ...
 * @author LENOVO
 */
public class Provincia_Tela extends javax.swing.JFrame {

    /**
     * Creates new form Provincia_Tela
     */
    public Provincia_Tela() {
        initComponents();
    }
    public void limpar(){
    ...
    private void btn_registarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registarActionPerformed
     ...
     Provincia pv = new Provincia(txt_nome.getText());
 ...
 gerente.getTransaction().commit();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Provincia_Tela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Provincia_Tela().setVisible(true);
            }
        });
    }
